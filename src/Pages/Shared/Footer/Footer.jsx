        ...
        <footer className="px-4 divide-y dark:bg-gray-800 dark:text-gray-100 mt-24 relative">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3 w-full">
                    <img src={logo} className="lg:w-40 w-36 absolute top-5 left-3 lg:top-5 lg:left-10" />
                </div>
                <div className="grid grid-cols-3 text-sm gap-x-3 gap-y-8 lg:w-2/3 lg:grid-cols-4 mt-10 ">
